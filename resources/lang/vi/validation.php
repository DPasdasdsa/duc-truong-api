...
return [
    ...
    'empty_array' => 'Trường :attribute không được bỏ trống.',
    'check_video_url' => 'Trường :attribute không đúng định dạng video.',
    'custom' => [
        'attribute-name' => [
    ...
    'attributes' => [
        ...
        'check_video_url' => 'video bài học',
        'reminder_daily' => 'nhắc nhở hàng ngày',
        'reminder_roadmap' => 'nhắc nhở theo lộ trình',
        'reminder_streak' => 'nhắc nhở theo streak',
        'comment' => 'bình luận',
        'analysis_result_lesson' => 'phân tích kết quả học',
        'notification_email_analysis' => 'phân tích kết quả học về email',
    ],
